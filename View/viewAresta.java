 ...
 * @author fredy_000
 */
public class viewAresta extends javax.swing.JFrame {
     ...
     */  
      ...
      Ruas ruas ;
      Frame frame1;
    public viewAresta(Ruas ruas,Pintar pinta ,int I,Frame frame){
       this.pintar =pinta;
       this.ruas=ruas;
       this.i=I;
       frame1 = frame;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Digite a 1º esquina");
        panel.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, -1, -1));

        jLabel2.setText("Digite a 2º esquina");
        panel.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, -1, -1));

        jLabel3.setText("Digite seu Tamanho");
        panel.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 100, -1));
        ...
        panel.add(n1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 30, 30, -1));
        ...
        panel.add(n2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 60, 30, -1));
        ...
        panel.add(tm, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 90, 30, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         if(n1.getText().length()<1 || n2.getText().length()<1 ||tm.getText().length()<1)
           JOptionPane.showMessageDialog(null,"Erro.. Falta dados : ");
         else{
         ...
         if(x==y)
           JOptionPane.showMessageDialog(null,"Erro.. Digitar uma esquina diferente a : "+y);
         else if(x<0 || x>=i || y<0 || y>=i){
            JOptionPane.showMessageDialog(null,"Erro.. esquinas invalidas "); 
         }else{
             ruas.setAdjacente(x, y, 1);
             ruas.setAdjacente(y, x, 1);
             ruas.setCoeficiente(x, y, ta);
             ruas.setCoeficiente(y, x, ta);
             n1.setText(null);
             n2.setText(null);
             tm.setText(null);
            Pintar.pintarLinha(Principal.jPanel1.getGraphics(),ruas.getVertical(x), ruas.getHorizontal(x), ruas.getVertical(y), ruas.getHorizontal(y), ta);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewAresta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
