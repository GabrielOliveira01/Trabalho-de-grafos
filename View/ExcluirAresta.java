 ...
 * @author fredy-18
 */
public class ExcluirAresta extends javax.swing.JFrame {
int i;
    /**
...
public void R_repaint(){
        for (int j = 0; j < i; j++) {
            for (int k = 0; k < i; k++) {
                ...
                Pintar.pintarLinha(Principal.jPanel1.getGraphics(),ruas.getVertical(j),ruas.getHorizontal(j), ruas.getVertical(k), ruas.getHorizontal(k),ruas.getCoeficiente(j, k));
            }
        }
        for (int j = 0; j < i; j++) {
            Pintar.pintarCirculos(Principal.jPanel1.getGraphics(), ruas.getVertical(j),ruas.getHorizontal(j),String.valueOf(ruas.getNome(j)));
 ...
 Pintar pintar ;
      Ruas ruas ;
      Frame frame;
    public ExcluirAresta(Pintar pinta , Ruas ruas ,int ii, Frame fram) {
        initComponents();
        i=ii;
        this.pintar =pinta;
       this.ruas=ruas;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Digite 1º esquina");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(10, 30, 110, 14);

        jLabel2.setText("Digite 2º esquina");
        jPanel1.add(jLabel2);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JOptionPane.showMessageDialog(null,"Error.. Faltan datos : ");
            ...
            JOptionPane.showMessageDialog(null,"Error.. Debe digitar un nodo diferente a : "+y);
                ...
                ruas.setAdjacente(x, y, 0);
                ruas.setAdjacente(y, x, 0);
                ruas.setCoeficiente(x, y, 0);
                ruas.setCoeficiente(y, x, 0);
                n1.setText(null);
                n2.setText(null);
                Principal.jPanel1.paint(Principal.jPanel1.getGraphics());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExcluirAresta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
